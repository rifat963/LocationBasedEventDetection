...
<div class="container-fluid" id="main">
  <div class="row">
      ...
      <p>
      <div id="button2" class="center-block btn btn-primary" onclick="allobject(); return false;">Search all Object</div>
        </p>
      <p>
      ...
      <div id="button2" class="center-block btn btn-primary" onclick="facebook(); return false;">Facebook</div>
       ...
       <p>
      <div id="button2" class="center-block btn btn-primary" onclick="matched(); return false;">Combine Dataset</div>
      </p>
     <!-- <p>
