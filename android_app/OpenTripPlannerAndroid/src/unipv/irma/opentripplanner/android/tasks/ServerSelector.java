...
package unipv.irma.opentripplanner.android.tasks;

import static unipv.irma.opentripplanner.android.OTPApp.PREFERENCE_KEY_AUTO_DETECT_SERVER;
import static unipv.irma.opentripplanner.android.OTPApp.PREFERENCE_KEY_CUSTOM_SERVER_URL;
import static unipv.irma.opentripplanner.android.OTPApp.PREFERENCE_KEY_CUSTOM_SERVER_URL_IS_VALID;
import static unipv.irma.opentripplanner.android.OTPApp.PREFERENCE_KEY_SELECTED_CUSTOM_SERVER;
import static unipv.irma.opentripplanner.android.OTPApp.PREFERENCE_KEY_SELECTED_SERVER;
...
import unipv.irma.opentripplanner.android.listeners.ServerCheckerCompleteListener;
...
//		Toast.makeText(activity.getApplicationContext(), shown, Toast.LENGTH_SHORT).show();
	...
	protected void onPostExecute(Long result) {
		...
		if (selectedServer != null) {
			...
			// cancella la scritta CUSTOM SERVER
			// cosi non è possibile inserire a mano il server.
