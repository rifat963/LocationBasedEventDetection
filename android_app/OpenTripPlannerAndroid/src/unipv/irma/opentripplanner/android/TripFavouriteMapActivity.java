...
import unipv.irma.opentripplanner.android.fragments.TripFavouriteFragment;
...
public class TripFavouriteMapActivity extends FragmentActivity implements OnFragmentListener{
	...
	private TripFavouriteFragment mainFragment;
	...
	//	bundle = (OTPBundle)getLastCustomNonConfigurationInstance();
		...
		if (savedInstanceState != null) {
			mainFragment = (TripFavouriteFragment) getSupportFragmentManager().findFragmentByTag(OTPApp.TAG_FRAGMENT_MAIN_FRAGMENT);//recuperar o tag adecuado e pillar ese fragment
			
	    }
		
		if(savedInstanceState==null){
			FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
			mainFragment = new TripFavouriteFragment();
...
//	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if ((keyCode == KeyEvent.KEYCODE_BACK)) {
			Intent i = new Intent (TripFavouriteMapActivity.this, TripFavouriteActivity.class);
			startActivity(i);
