...
public class TripFavouriteModel {
	private int id;
	private int user_id;
	...
	private static TripFavouriteModel instance = null;

	public TripFavouriteModel() {
	}

	public static TripFavouriteModel getInstance() {
		if (instance == null) {
			instance = new TripFavouriteModel();
		}
		return instance;
	}
