...
import unipv.irma.opentripplanner.android.adapters.FavouriteTripAdapter;
...
public class TripFavouriteActivity extends Activity {
	...
	FavouriteTripAdapter adapter;
	ArrayList<TripFavouriteModel> listTrip;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_trip_favourite);
		...
		btn_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(TripFavouriteActivity.this, DashboardActivity.class);
				startActivity(i);
	...
	{	
	    ...
	    {
	    	super.onPreExecute();  
	    	progressDialog = ProgressDialog.show(TripFavouriteActivity.this,"",getResources().getString(R.string.connecting));
	    ...
	    {
	    	String url = Constants.PATH_SERVER + Constants.PATH_GET_FAVOURITE_TRIP;
	    	ArrayList<NameValuePair> values = new ArrayList<NameValuePair>();
	    	values.add(new BasicNameValuePair("user_id",UserModel.getInstance().getId() + ""));

	    	jsonResult = connection.getResult(TripFavouriteActivity.this, url, values);
	    	...
	    	if (status == 200) {
	    		...
	    		if (result.equals("OK")){
	    			...
	    			try {
						...
						listTrip = new ArrayList<TripFavouriteModel>();
						for (int i = 0; i < data.length(); i++) {
							TripFavouriteModel tripModel = new TripFavouriteModel();
		    	    ...
		    	    adapter = new FavouriteTripAdapter(TripFavouriteActivity.this, listTrip);
		    	    tripListView.setAdapter(adapter); 
	    		} 
	    		// userId or Email not exist!
	    		else {
		    		getDialog(getResources().getString(R.string.trip_favourite_fail), true);
	    		}
	    	} 
	...
	public void getDialog(String msg, final boolean ok) {
        AlertDialog.Builder builder = new AlertDialog.Builder(TripFavouriteActivity.this);
